...
<!-- What does this MR change and why? Link the roadmap item (moon/ROADMAP.md) or issue it closes. -->
...
- [ ] `component:ci-automation` — CI, bots, repo automation (`.gitlab/`, `github/`)
